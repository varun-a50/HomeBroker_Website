<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Homes in Pune.aspx.cs" Inherits="Project1.Homes_in_Pune" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:DataList ID="DataList1" runat="server" DataSourceID="SqlDataSource1" RepeatColumns="3" RepeatDirection="Horizontal" OnItemCommand="DataList1_ItemCommand1" Class="text-center">
        <ItemStyle Height="450px" width="450px" Wrap="True" />
    <ItemTemplate>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:homebrokerConnectionString %>" SelectCommand="SELECT * FROM [Home_Details] where place = 'Pune'"></asp:SqlDataSource>
    <br />
    <br />
