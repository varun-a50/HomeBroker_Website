<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="userprofile.aspx.cs" Inherits="Project1.userprofile" %>
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                           ...
                           <asp:Label class="badge badge rounded-pill bg-info text-dark" ID="Label1" runat="server" Text="Your status"></asp:Label>
                        </center>
                     </div>
                  </div>
                  <div class="row">
